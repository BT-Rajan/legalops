...
// Real deltas — opened this month vs same period last month
...
[$closeDir,  $closeDelta,  $closeClass]  = delta_info($closedCases,   0); // closed total — show year-to-date instead
...
// Activity — fetch with action type so JS can filter client-side
$activity = $pdo->query(
